...
Read more about the Rapberry pi motherboard [here](./01-raspberry_pi_motherboard/01-documentation/raspberry_pi_motherboard.md)

Read more about the satellite module [here](./02-module_satellite/01-documentation/module.md)
